...
# Example usage:
website = "https://git.digitalharborbolivia.com:8081"  # Replace with your desired URL

html_content = getdata(website)
# create empty dict
dict_href_links = {}
...
website = "https://https://git.digitalharborbolivia.com:8081"
